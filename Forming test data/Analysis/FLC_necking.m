...
raw_10mm = xlsread('Strain path data_necking.xlsx','Sheet1','B4:U128');


% importing all 20 mm data
raw_20mm = xlsread('Strain path data_necking.xlsx','Sheet2','B4:U121');

 
% % importing all 40 mm data
raw_40mm = xlsread('Strain path data_necking.xlsx','Sheet3','B4:U131');


% importing all 60 mm data
raw_60mm = xlsread('Strain path data_necking.xlsx','Sheet4','B4:U129');


% % importing all 120 mm data
raw_120mm = xlsread('Strain path data_necking.xlsx','Sheet5','B4:U127');



 % importing all 177 mm data
raw_177mm = xlsread('Strain path data_necking.xlsx','Sheet6','B4:U137');
...
print(gcf,'FLC_necking.svg','-dsvg','-r600');
