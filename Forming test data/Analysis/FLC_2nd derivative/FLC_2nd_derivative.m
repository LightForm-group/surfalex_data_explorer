...
raw_10mm = xlsread('Strain path data_2nd derivative.xlsx','Sheet1','A4:W147');


% importing all 20 mm data
raw_20mm = xlsread('Strain path data_2nd derivative.xlsx','Sheet2','A4:W142');


% importing all 40 mm data
raw_40mm = xlsread('Strain path data_2nd derivative.xlsx','Sheet3','A4:W153');


% importing all 60 mm data
raw_60mm = xlsread('Strain path data_2nd derivative.xlsx','Sheet4','A4:W157');


% importing all 120 mm data
raw_120mm = xlsread('Strain path data_2nd derivative.xlsx','Sheet5','A4:W152');


% importing all 177 mm data
raw_177mm = xlsread('Strain path data_2nd derivative.xlsx','Sheet6','A4:W159');
...
print(gcf,'FLC_2nd_derivative.svg','-dsvg','-r600');
